...
urlpatterns = [
    ...
    path('product-categories/', ProductCategoryView.as_view(), name='product_category_url'),
    ...
    path('spacial_products/', SpecialProductsView.as_view(), name='special_products_url'),
]
